 ...
 * @author USER
 */
public class FileTailSource extends GraphStage<SourceShape<ByteString>> {
     ...
     * Java API:
     *
     * Read the entire contents of a file, and then when the end is reached,
     * keep reading newly appended data. Like the unix command `tail -f`.
     *
     * Aborting the stage can be done by combining with a
     ...
     * @param pollingInterval When the end has been reached, look for new
     * content with this interval
     */
